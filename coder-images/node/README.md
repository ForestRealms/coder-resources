# Node.js | Coder Resources - Docker Template Images
This directory providing standardized Docker Images for **Coder workspace templates**.

## Overview
Pre-built, production-ready Node.js images optimized for Coder remote development environments. Built from official upstream images with consistent tooling and configuration.

## Key Details
- **Base Image**: Official Node.js (Ubuntu Noble)
- **Supported Node.js Versions**: 22, 24, 25, 26
- **Default Tag**: `latest` → Node.js 26
...
## Features
- Lightweight, production-grade Node.js environment
...
- Consistent tagging across all Node.js versions
...
`harbor.cluster.internal/coder-images/node`
...
- Provides unified Node.js environments for development teams
